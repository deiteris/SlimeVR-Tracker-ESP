...
struct VQFState {
     ...
     */
    float restLastSquaredDeviations[3];
    /**
...
public:
     ...
     * @param out output array of size 3 for the relative rest deviations
      */
    void getRelativeRestDeviations(float out[3]) const;
    /**
     ...
     */
    void setRestDetectionThresholds(float thGyr, float thAcc, float thMag);
     ...
     */
    static void filterInitialState(float x0, const double b[], const double a[], double out[2]);
    /**
